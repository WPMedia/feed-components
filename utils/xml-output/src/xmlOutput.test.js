...
const exampleData = [
    {
        rss: {
            ...
            channel: {
                ...
                'atom:link': {
                    '@href': 'https://corecomponents-the-gazette-prod.cdn.arcpublishing.com/',
                    '@rel': 'self',
                ...
                item: [
                    ...
                    },
                    {
                        ...
                        '#': [
                            {
                                'media:content': {
                                    '@url': 'https://corecomponents-the-gazette-prod.cdn.arcpublishing.com/resizer/WHs28CYC_hGdxryDL_EJsSx7oWY=/arc-anglerfish-arc2-sandbox-sandbox-corecomponents.s3.amazonaws.com/public/SQCYL5S5IFDYLF76K5SFSFHLVU.jpg',
                                    '@type': 'image/jpeg',
                                    '@height': 835,
                                    '@width': 1114
                                }
...
const exampleDataInvalid = [
    {
        rss: {
            ...
            channel: {
                ...
                item: [
                    {
                        title: { '$': 'ä, ë, ï, ö, ü, ÿ, Ä, Ë, Ï, Ö, Ü, Ÿ, â, ê, î, ô, û, Â, Ê, Î, Ô, Û, á, é, í, ó, ú, ý, Á, É, Í, Ó, Ú, Ý, à, è, ì, ò, ù, À, È, Ì, Ò, Ù' },
                        link: 'https://corecomponents-the-gazette-prod.cdn.arcpublishing.com/2019/04/17/test-story-1/',
                        guid: {
                            '#': 'https://corecomponents-the-gazette-prod.cdn.arcpublishing.com/2019/04/17/test-story-1/',
                            '@isPermaLink': true
                        ...
                        '#': [
                            {
                                'media:content': {
                                    ...
                                    '@height': 835,
                                    '@width': 1114,
                                    'media:description': { '@type': 'plain', $: 'Description has character' },
                                    'media:credit': {
                                        '@role': 'author',
                                        '@scheme': 'urn:ebu',
                                        '#': 'Author ends in␀',
